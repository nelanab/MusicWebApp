...
<script>
  ...
  import navigationContainer from '../components/nav.vue';
  import singlealbum from '../components/showAlbum.vue'
  export default {
      components: { singlealbum, playbar, tabs, navigationContainer }
  }
